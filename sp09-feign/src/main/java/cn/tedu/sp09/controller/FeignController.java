...
import cn.tedu.sp09.service.UserFeignServicer;
...
public class FeignController {
	...
	@Autowired
	private UserFeignServicer  userService;
	@Autowired
	...
	public JsonResult addSocre(@PathVariable Integer userId,Integer score) {
		return userService.addSocre(userId, score);
	}
	//order
